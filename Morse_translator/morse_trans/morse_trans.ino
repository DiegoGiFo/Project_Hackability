...
const unsigned long dotDuration = 150; // duration [ms] of a dot; basic time unit
const unsigned long tolerance = 50; // duration that dash, dot or gap may deviate from the ideal length in order to still be recognized
const unsigned long dashDuration = 300;
const unsigned long shortGap = 400;
const unsigned long mediumGap = 1000;
const unsigned long longGap = 1500;
